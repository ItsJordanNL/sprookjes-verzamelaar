...
class _VerzamelingState extends State<Verzameling> {
  ...
  Positioned _collectionBadge(double progress) {
    return Positioned(
            top: 15,
  ...
  Positioned _collectionProgress(BuildContext context, double progress) {
    return Positioned(
            top: 0,
            left: 0,
            right: 0,
  ...
  SingleChildScrollView _gridItems(BuildContext context) {
